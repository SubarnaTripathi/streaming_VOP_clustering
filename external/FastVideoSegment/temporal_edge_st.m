...
function io_mask_all = temporal_edge_st(foldername, video_file, range, positiveRanges)
...
%% flow_option
%flow_options.outfolder = fullfile( 'home/my_code', 'Data', 'outputs', video_file); %'youtube_small' );
...
for( shot = options.positiveRanges )
    ...
    io_mask = videoRapidSegment( options, params, data );
