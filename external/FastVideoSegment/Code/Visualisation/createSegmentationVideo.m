...
%             segmentationImg = gray2rgb(255 * segmentation{ index });
            ...
            locationImg = getHeatmap(locationProbability{ index }, true); %% subarna: false;
            appearanceImg = getHeatmap(appearanceProbability{ index }, true); %% subarna : false
            unaryImg = getHeatmap(unaryPotential{ index }, true); %% subarna false;
            segmentationImg = gray2rgb(255 * segmentation{ index });
