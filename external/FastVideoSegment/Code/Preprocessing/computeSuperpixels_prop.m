...
function superpixels = computeSuperpixels_prop( options, shot, first_frame, last_frame)
    ...
    superpixels = computeSLIC_prop( options, shot, first_frame, last_frame );
...
%             superpixels = computeSLIC_prop( options, shot, t_frame );
%         else
