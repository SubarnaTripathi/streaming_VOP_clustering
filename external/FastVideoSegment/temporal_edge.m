...
function io_mask_all = temporal_edge(foldername, video_file, range, positiveRanges)
...
%% flow_option
flow_options.outfolder = fullfile( foldername, 'Data', 'outputs', video_file); %'youtube_small' );
